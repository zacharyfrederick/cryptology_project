...
Overview
*****
GatorChat is an ecrypted peer to peer chat client. It is built using a client and Django server that handles key distribution and authentication. To start 
browsing the documentation head over to the :ref:`modindex` page.
...
Steps to run:
    1. Start the django server by running *python manage.py runserver* from the *server/chat_server/chat_server/* directory
...
To change that you will need to change the client code which connects to the server. 
